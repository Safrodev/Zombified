package safro.zombified.entity.model;
...
public class BruteZombieEntityModel<T extends BruteZombieEntity> extends SinglePartEntityModel<T> {
    ...
    public BruteZombieEntityModel(ModelPart root) {
        this.root = root;
